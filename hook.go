...
import (
	...
	"github.com/puzzir/elogrus/internal/bulk"
	"net/http"
	"strings"
	"sync"
	"time"
...
func NewElasticHook(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, index string) (*ElasticHook, error) {
	return NewElasticHookWithFunc(client, host, project, type_, level, func() string { return index })
}
...
// level - log level
// index - name of the index in ElasticSearch
func NewAsyncElasticHook(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, index string) (*ElasticHook, error) {
	return NewAsyncElasticHookWithFunc(client, host, project, type_, level, func() string { return index })
}
...
// level - log level
// index - name of the index in ElasticSearch
func NewBulkProcessorElasticHook(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, index string) (*ElasticHook, error) {
	return NewBulkProcessorElasticHookWithFunc(client, host, project, type_, level, func() string { return index })
}
...
func NewElasticHookWithFunc(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, indexFunc IndexNameFunc) (*ElasticHook, error) {
	return newHookFuncAndFireFunc(client, host, project, type_, level, indexFunc, syncFireFunc)
}
...
// level - log level
// indexFunc - function providing the name of index
func NewAsyncElasticHookWithFunc(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, indexFunc IndexNameFunc) (*ElasticHook, error) {
	return newHookFuncAndFireFunc(client, host, project, type_, level, indexFunc, asyncFireFunc)
}
...
// level - log level
// indexFunc - function providing the name of index
func NewBulkProcessorElasticHookWithFunc(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, indexFunc IndexNameFunc) (*ElasticHook, error) {
	fireFunc, err := makeBulkFireFunc(client)
	if err != nil {
		return nil, err
	}
	return newHookFuncAndFireFunc(client, host, project, type_, level, indexFunc, fireFunc)
}

func newHookFuncAndFireFunc(client *elasticsearch.Client, host, project, type_ string, level logrus.Level, indexFunc IndexNameFunc, fireFunc fireFunc) (*ElasticHook, error) {
